                  ...
                  <div class="card-body p-0" style="border-radius:10px;">
                    <div class="clearfix p-2 m-0" style="background-image: linear-gradient(to right, #0081b6, #74b6d1);   border-top-left-radius: 10px;border-top-right-radius: 10px;">
                      <div class="row">
                        ...
                        <h4 class="card-title float-left m-0 p-0" style="color:white;">Demand Forecasting And Planning</h4>
                        </div>
                    ...
                    <div class="table-wrapper">
                        <table class="table table-bordered border-primary">
                            ...
                            <tr>    
                                ...
                                <th rowspan="2">Upcoming Inward</th>
                            ...
                            @foreach($allocations as $allocation)
                              <tr>
                                ...
                                @php($inwardStock = 500)
                                @endif
                                <td>{{$allocation->demand_forecast - $allocation->current_stock_level - $inwardStock}}pcs.</td>
                                <td>{{$allocation->current_stock_level}}pcs.</td>
                                <td>{{$inwardStock}}pcs.</td>
