                  ...
                  <div class="card-body p-0" style="border-radius:10px;">
                    <div class="clearfix p-2 m-0" style="background-image: linear-gradient(to right, #0081b6, #74b6d1);   border-top-left-radius: 10px;border-top-right-radius: 10px;">
                      <div class="row">
                        ...
                        <h4 class="card-title float-left m-0 p-0" style="color:white;">Return And Rejection</h4>
                        </div>
                ...
                <div id="visit-sale-chart-legend" class="rounded-legend legend-horizontal legend-top-right float-right"></div>
                    ...
                    <div class="table-wrapper">
                        ...
                        <tr>    
                                ...
                                <th rowspan="2">Return Reciept</th>
                            ...
                            @for($a=0;$a<4;$a++) 
                              @if($data->failed_qty > 0 &&  $data->inspection_status == 1)
                            <tr>
                                <td>{{$i++}}</td>
                                <td><a class="btn btn-primary mdi mdi-eye" data-bs-target="#GRNiewModal" data-bs-toggle="modal"></a></td>
                                ...
                                <td>{!!$data->visual_inspection_notes!!}</td>
                                <td><a style="color:red;"><b>Rejected</b></a></td>
                                @if($data->inspection_status == 1)
                                <td><a class="mdi mdi-check-circle text-success" style="font-size:20px;"></a></td>
                                @else
                                <td></td>
                                @endif
                                <td><a class="btn btn-primary">Notify Supplier</a></td>
                ...
                <div class="modal fade" id="GRNiewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="GRNiewModalLabel" aria-hidden="true">
                  <div class="modal-dialog  modal-lg mx-auto">
                    <div class="modal-content card mx-auto">
                      <div class="modal-header">
                        <h5 class="modal-title" id="GRNiewModalLabel">Return/Repair Receipt</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      
                    <div class="modal-body">
                      <center>
                        <img src="https://rossum.ai/use-cases/img/illust/documents/return_receipt_for_goods.jpeg" style="height:100vh;object-fit:cover;" alt="">
                      </center>
