...
@include('admin.layout.navbar', ['modules' => $modules = App\Models\moduleMaster::all()])
   <div class="main-panel main-panel-dashboard">
      ...
      @if(Auth::user()->admin == 3 || Auth::user()->admin == 6 || Auth::user()->admin == 8 || Auth::user()->admin == 9)
      <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{asset('backend/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total Inventory<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{asset('backend/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Weekly Sales Orders <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{asset('backend/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total PO's<i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">5,741</h2>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pe-1">
                        <img src="{{asset('backend/images/dashboard/img_1.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{asset('backend/images/dashboard/img_4.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 ps-1">
                        <img src="{{asset('backend/images/dashboard/img_2.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{asset('backend/images/dashboard/img_3.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="{{asset('backend/images/faces/face3.jpg')}}" class="img-sm rounded-circle me-3" alt="image">
