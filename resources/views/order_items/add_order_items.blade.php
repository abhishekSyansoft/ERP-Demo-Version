...
<div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-md-12 mb-4">
              <button class="btn btn-primary" id="order_accordian_toggle">Toggle Forms</button>
              <button class="btn btn-primary" id="add_order_page">Add Order &nbsp;&nbsp;&nbsp;<i class="mdi mdi-newspaper"></i></button>
              <button class="btn btn-primary m-1" id="past_generated_order" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="float:right;">Edit Order &nbsp;&nbsp;&nbsp;<i class="mdi mdi-pen"></i></button>
              ...
              <button class="btn btn-primary m-1" id="view_errors" style="float:right;">View Errors &nbsp;&nbsp;&nbsp;<i class="mdi mdi-alert-circle"></i></button>
            </div>
