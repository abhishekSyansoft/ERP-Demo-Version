                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="category" class="tabcontent">
                        <h3>Add Category</h3>
                        <form action="{{route('add.cat')}}" method="POST" class="row">
                            @csrf
                            <div class="form-group col-md-6">
                                <label for="name" class="form-control-label"><b>Name:<sup style="color:red;font-size:15px;">*</sup></b></label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter name to add category">
                            </div>
