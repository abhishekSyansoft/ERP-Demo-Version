          ...
          <div class="content-wrapper mx-auto">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Inventory Valuation management
              </h3>
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span> Inventory Valuation management<i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
                  ...
                  <div class="card-body p-0" style="border-radius:10px;">
                    <div class="clearfix p-2 m-0" style="background-image: linear-gradient(to right, #0081b6, #74b6d1);   border-top-left-radius: 10px;border-top-right-radius: 10px;">
                      <div class="row">
                        ...
                        <h4 class="card-title float-left m-0 p-0" style="color:white;">Valuation Lists</h4>
                        </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="background-color:white;">
      ...
      <div class="modal-body">
        <!-- Rescource Form -->
                <form method="POST" action="{{route('iv.store')}}" class="row">
                        @csrf
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="unit_cost" class="form-label">{{ __('Unit Price') }}</label>
                            <input type="text" id="unit_cost" class="form-control" name="unit_cost" placeholder="Enter product unit_price" required>
                        </div>

                        <div class="mb-3 col-md-6">
                            <label for="total_value" class="form-label">{{ __('Total Value') }}</label>
                            <input type="text" id="total_value" class="form-control" name="total_value" placeholder="Enter the total value of product" required>
                        </div>
