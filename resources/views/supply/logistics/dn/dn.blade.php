                  ...
                  <div class="card-body p-0" style="border-radius:10px;">
                    <div class="clearfix p-2 m-0" style="background-image: linear-gradient(to right, #0081b6, #74b6d1);   border-top-left-radius: 10px;border-top-right-radius: 10px;">
                      <div class="row">
                        ...
                        <h4 class="card-title float-left m-0 p-0" style="color:white;">Network Lists</h4>
                        </div>
                        ...
                        <table class="table" style="width: 100%;">
                            ...
                            @for($a=0;$a<7;$a++)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('edit-dn/'.$encryptedId)}}" class="btn btn-primary">Edit</a>
                                        <a href="{{url('delete-dn/'.$encryptedId)}}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                @endfor
                            @endforeach
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="background-color:white;">
      <div class="modal-header">
        <h4 class="modal-title" id="addSupplierModalLabel">Add Distribution Network</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <!-- Rescource Form -->
                <form method="POST" action="{{route('dn.store')}}" class="row">
                        @csrf
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="location" class="form-control" name="location" placeholder="Enter the location to make a new network" required>
                        </div>

                        <div class="mb-3 col-md-6">
                            <label for="capacity" class="form-label">{{ __('Capacity') }}</label>
                            <input type="text" id="capacity" placeholder="Capacity of the warehouse" class="form-control" name="capacity" required>
                        </div>
