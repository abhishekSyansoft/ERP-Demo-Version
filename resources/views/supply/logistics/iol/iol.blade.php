                  ...
                  <div class="card-body p-0" style="border-radius:10px;">
                    <div class="clearfix p-2 m-0" style="background-image: linear-gradient(to right, #0081b6, #74b6d1);   border-top-left-radius: 10px;border-top-right-radius: 10px;">
                      <div class="row">
                        ...
                        <h4 class="card-title float-left m-0 p-0" style="color:white;">Inbound/Outbound Logistics Lists</h4>
                        </div>
        ...
        <!-- Rescource Form -->
                <form method="POST" action="{{route('iol.store')}}" class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="transport_id" class="form-label">{{ __('Transportation Mode') }}</label>
