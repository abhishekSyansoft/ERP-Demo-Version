              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span> Goods Recieving Note's:<i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
                ...
                <div class="card mx-auto">
                  <div class="card-body">
                    <div class="clearfix">
                        ...
                        <hr>
                      <h4 class="card-title float-left"> Goods Recieving Note's Lists</h4>
